        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >   
                ...
                >
                    ...
                    >
                        I'm a full stack web developer and rising junior at Wingate University studying Mathematics and Computer Science. I specialize in building modern, responsive websites and web applications that help businesses establish their online presence and connect with their audience effectively.

                        My work focuses on creating clean, user-friendly interfaces with React and Tailwind CSS, building robust backend systems with Node.js, and deploying scalable applications. I've successfully delivered projects for educational institutions, global organizations, and various businesses across different industries.

                        As a first-generation college student, I'm passionate about using technology to create meaningful impact. I combine my analytical background with creative problem-solving to build digital solutions that drive real results for my clients.
                    </p>
                    <p
                        className={`text-base leading-relaxed ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}
                    >
                        When I'm not coding, you'll find me exploring new technologies and working on the following...
                    </p>
                </motion.div>

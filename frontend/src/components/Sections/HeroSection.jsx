...
import PROFILE_IMG_2 from '../../assets/images/Foster Oppong.jpg';
            ...
            <div className='max-w-7xl mx-auto w-full z-10 mt-20'>
                ...
                <div className='block lg:hidden'>
                    ...
                    >
                        ...
                        >
                            I craft modern, responsive websites and web applications that help businesses establish their online presence and connect with their audience effectively.
                        </motion.p>
                ...
                <div className='hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center'>
                    ...
                    >
                        ...
                        >
                            ...
                            <br />
                            <span className='text-blue-500 font-medium'>Digital</span>
                            <br />
                            <span
                                className={isDarkMode ? "text-white" : "text-gray-900"}
                            >
